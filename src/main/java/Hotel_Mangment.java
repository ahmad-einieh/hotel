...
public class Hotel_Mangment extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 978,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)));
        jPanel1Layout.setVerticalGroup(
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 546,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)));
    ...
    private void insertRoleActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_insertRoleActionPerformed
        ...
        try {
            Connection c = DriverManager.getConnection("jdbc:mysql://localhost/manage_hotel", "your username",
                    "your password");
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                PreparedStatement p = c
                        .prepareStatement("INSERT INTO `customer`(`ID`, `name`,`roomNumber`) VALUES (?,?,?)");
                p.setInt(1, ID);
                p.setString(2, name);
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                PreparedStatement p = c.prepareStatement(
                        "UPDATE `customer` SET `name` = ? ,`roomNumber`= ? WHERE `customer`.`ID` = ?");
                p.setString(1, name);
    ...
    private void insertEmployeeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_insertEmployeeActionPerformed
        ...
        if (id.length() != 0 && salary.length() != 0 && hotelID.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("INSERT INTO `employee`(`ID`, `name`, `salary`, `HotelID`) VALUES (?,?,?,?)");
                p.setInt(1, ID);
                p.setString(2, name);
    ...
    private void updateEmployeeActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateEmployeeActionPerformed
        ...
        if (id.length() != 0 && salary.length() != 0 && hotelID.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c.prepareStatement(
                        "UPDATE `employee` SET `name` = ?, `salary` = ?, `HotelID` = ? WHERE `employee`.`ID` = ?");
                p.setString(1, name);
    ...
    private void insertRoomActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_insertRoomActionPerformed
        ...
        if (number.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("INSERT INTO `room`(`number`, `price`, `type`, `HotelID`) VALUES (?,?,?,?)");
                p.setInt(1, Number);
                p.setDouble(2, Price);
                p.setString(3, type);
                p.setInt(4, HotelID);
    ...
    private void updateHotel1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (x.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("UPDATE `hotel` SET `name`=?,`location`=? WHERE `hotel`.`ID` = ?");
                // p.setInt(1,ID);
                p.setString(1, name);
    ...
    private void instertHotel2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("INSERT INTO `hotel`(`ID`, `name`, `location`) VALUES (?,?,?)");
                p.setInt(1, ID);
                p.setString(2, name);
    ...
    private void updateRoomActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateRoomActionPerformed
        ...
        if (number.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("UPDATE `room` SET `price`=?,`type`=?,`HotelID`=? WHERE `room`.`number` = ?");
                p.setDouble(1, Price);
                p.setString(2, type);
                p.setInt(3, HotelID);
                p.setInt(4, Number);
    ...
    private void removeWorkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_removeWorkActionPerformed
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c.prepareStatement(
                        "DELETE FROM `working as` WHERE (`working as`.`EmployeeID` = ? and `working as`.`RoleName` = ?) ");
                p.setInt(1, ID);
                p.setString(2, name);
                p.execute();
                c.close();
    ...
    private void updateWorkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_updateWorkActionPerformed
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("UPDATE `working as` SET `RoleName`= ? WHERE `working as`.`EmployeeID` = ?");
                p.setString(1, name);
                p.setInt(2, ID);
                p.execute();
                c.close();
    ...
    private void insertWorkActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_insertWorkActionPerformed
        ...
        if (id.length() != 0) {
            ...
            try {
                ...
                System.out.println("connection done");
                PreparedStatement p = c
                        .prepareStatement("INSERT INTO `working as`(`EmployeeID`, `RoleName`) VALUES (?,?)");
                p.setInt(1, ID);
                p.setString(2, name);
                p.execute();
                c.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hotel_Mangment.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
